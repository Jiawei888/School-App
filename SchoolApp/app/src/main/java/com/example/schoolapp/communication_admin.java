...
public class communication_admin extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.communication_admin);
        //final DBOpenHelper mDBOpenHelper = new DBOpenHelper(this);

        mDBOpenHelper = new DBOpenHelper(this);
        title = findViewById(R.id.register_communication_admin);
        content = findViewById(R.id.register_communication_content_admin);
        ...
        sure = (Button) findViewById(R.id.communication_button_admin);
                ...
                if (!TextUtils.isEmpty(title_text) && !TextUtils.isEmpty(content_text)) {
                    ...
                    if(date_flag != null && date_flag.equals("Null"))  //enter this activity from student/parent
                    {
                        ...
                        if (havedata.equals("true"))
                        {
                            ...
                            mDBOpenHelper.add_info("All Parents", "ALL", "ALL", "Parents", title_text, content_text, date_text, "communication");

                        }

                    }

                    Intent intent = new Intent(communication_admin.this, MainActivity_Admin.class);
                    startActivity(intent);
                    finish();
                    Toast.makeText(communication_admin.this, "Create or update Successfully", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(communication_admin.this, "Do not send a empty Communication", Toast.LENGTH_SHORT).show();
                }
