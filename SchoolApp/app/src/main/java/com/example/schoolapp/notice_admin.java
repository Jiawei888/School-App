...
public class notice_admin extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title = findViewById(R.id.register_notice_admin);
        content = findViewById(R.id.register_notice_content_admin);
        ...
        sure = (Button) findViewById(R.id.notice_button_admin);
                ...
                if (!TextUtils.isEmpty(title_text) && !TextUtils.isEmpty(content_text)) {
                    ...
                    if(date_flag != null && date_flag.equals("Null"))  //enter this activity from student/parent
                    {
                        ...
                        if (havedata.equals("true"))
                        {
                            ...
                            mDBOpenHelper.add_info("All Students", "ALL", "ALL", "Students", title_text, content_text, date_text, "notice");

                        }

                    }

                    Intent intent = new Intent(notice_admin.this, MainActivity_Admin.class);
                    startActivity(intent);
                    finish();
                    Toast.makeText(notice_admin.this, "Create or update Successfully", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(notice_admin.this, "Do not send a empty NoticeBoard", Toast.LENGTH_SHORT).show();
                }
