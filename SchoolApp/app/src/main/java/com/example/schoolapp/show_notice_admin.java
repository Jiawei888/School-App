...
public class show_notice_admin extends AppCompatActivity{
    ...
    private noticeAdapter_admin adapter; //gai

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        //requestWindowFeature(Window.FEATURE_NO_TITLE);
        setContentView(R.layout.noticeinfo_activity_admin);   //gai
        ...
        adapter = new noticeAdapter_admin(show_notice_admin.this, R.layout.notice_item_admin, studentList); //gai
        listView_admin = (ListView) findViewById(R.id.notice_view_admin); //gai
        ...
        listView_admin.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(show_notice_admin.this);
                LayoutInflater factory = LayoutInflater.from(show_notice_admin.this);
                final View textEntryView = factory.inflate(R.layout.notice_info_admin, null);//加载AlertDialog自定义布局  //gai
                builder.setView(textEntryView);
                builder.setTitle("Please select a feature");

                Button selectInfo = (Button) textEntryView.findViewById(R.id.notice_info_select);//查看学生详细信息按钮  //gai
                selectInfo.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        //再次弹出一个alertDialog，用于显示详细学生信息
                        AlertDialog.Builder select_builder = new AlertDialog.Builder(show_notice_admin.this);  //gai
                        select_builder.setTitle("NoticeBoard Detail");
                ...
                //删除学生信息
                Button delete_info = (Button) textEntryView.findViewById(R.id.notice_info_delete); //gai
                ...
                delete_info.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        final AlertDialog.Builder delete_builder = new AlertDialog.Builder(show_notice_admin.this); //gai
                        delete_builder.setTitle("Warning！！！！");
                        delete_builder.setMessage("You will delete this noticeboard, this operation is not reversible, please be careful！");
                ...
                Button update_info = (Button) textEntryView.findViewById(R.id.notice_info_update);  //gai
                update_info.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        //跳转到添加学生信息的界面,通过intent传递数据
                        Intent intent = new Intent(show_notice_admin.this, notice_admin.class);  //gai
                        ...
                        finish();
                        Toast.makeText(show_notice_admin.this, "Please update NoticeBoard to this student or students",
